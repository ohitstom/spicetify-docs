...
- Make a new folder for your custom app in your [CustomApps folder](../getting-started/customization/local-addons#location). You'll install it like any other custom app.
